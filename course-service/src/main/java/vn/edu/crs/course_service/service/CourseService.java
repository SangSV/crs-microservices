...
public class CourseService {
    ...
    public CourseDTO create(CourseDTO dto) {
        ...
        course.setSoChoConLai(dto.getSoChoToiDa()); // tự động gán bằng số chỗ tối đa
    ...
    // 2. Hàm API nội bộ: Trừ chỗ (Reserve)
    @Transactional
    ...
    // 3. Hàm API nội bộ: Hoàn chỗ (Release)
    @Transactional
